...
![一軍登録抹消履歴](https://hanshintigers.jp/game/regist/history.html "一軍登録抹消履歴")

makecsv.py
一軍登録抹消履歴ページを scrapeして tigers_reg_history.csv を出力
![サンプル](https://github.com/koichiro61/tigers_registration/blob/dd6de4f1bc4b23f33f4e8aa2dd041aa41cdc4775/tigers_reg_history.csv "一軍登録抹消履歴")
